...
st.title("Face Mask Detection App (TFLite)")
st.write("Upload a face image to check if a mask is present.")
...
st.markdown("---")
st.markdown("**Professional Face Mask Detection App (TFLite) built with Streamlit and TensorFlow Lite.**")
st.markdown("For best results, use clear, front-facing face images.")
